...
public class DetilActivity extends AppCompatActivity {
        ...
        mAdapter.setOnItemClickLitener(new DetilListAdapter.OnItemClickLitener() {
            ...
            public void onItemClick(View view, final int position) {
                switch (position) {
                    ...
                    case 8:
                    case 9:
                        mView = View.inflate(com.inhatc.attendance.DetilActivity.this, R.layout.dialog_edittext, null);
                        mEt_data = (EditText) mView.findViewById(R.id.et_data);
                        String data = mAdapter.getData(position);
                        mEt_data.setText(data);
                        AlertDialog.Builder builder = new AlertDialog.Builder(com.inhatc.attendance.DetilActivity.this);
    ...
    protected void dialogshow() {
        mpDialog = new ProgressDialog(com.inhatc.attendance.DetilActivity.this);
